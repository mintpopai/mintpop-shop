package ai.mintpop.shop.entity;
...
public class Product {
    ...
    /** 展示销量：管理员手填的销量基数，NOT NULL DEFAULT 0；前台展示 = displaySales + soldCount */
    private Integer displaySales;
    /** 实际销量：订单首次入账时按购买数量累加（相对更新，见 ProductMapper.addSoldCount），管理端只读 */
