...
import ai.mintpop.shop.config.AppMailProperties;
import ai.mintpop.shop.entity.OrderShipment;
import ai.mintpop.shop.entity.Product;
import ai.mintpop.shop.entity.ShopOrder;
import ai.mintpop.shop.entity.ShopUser;
import ai.mintpop.shop.enumeration.BizCodeEnum;
import ai.mintpop.shop.enumeration.OrderStatusEnum;
import ai.mintpop.shop.enumeration.ShipmentEmailStatusEnum;
...
import ai.mintpop.shop.mapper.ShopUserMapper;
import ai.mintpop.shop.response.AdminShipmentItemResponse;
import ai.mintpop.shop.response.AdminShipmentResponse;
